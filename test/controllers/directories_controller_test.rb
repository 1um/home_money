...
class DirectoriesControllerTest < ActionController::TestCase
  ...
  test "should create directory" do
    assert_difference('Directory.count') do
      post :create, directory: { directories_purchases_id: @directory.directories_purchases_id, name: @directory.name }
    end
  ...
  test "should update directory" do
    patch :update, id: @directory, directory: { directories_purchases_id: @directory.directories_purchases_id, name: @directory.name }
    assert_redirected_to directory_path(assigns(:directory))
  end
